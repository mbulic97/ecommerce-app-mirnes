...
class AddressViewModel @Inject constructor(
    ...
    private val _addNewAddress= MutableStateFlow<Resource<com.example.ecommerceappmirnes.data.Address>>(Resource.Unspecified())
    val addNewAddress=_addNewAddress.asStateFlow()

    private val _error= MutableSharedFlow<String>()
    val error= _error.asSharedFlow()
    fun addAddress(address: com.example.ecommerceappmirnes.data.Address){
    ...
    private fun validateInputs(address: com.example.ecommerceappmirnes.data.Address): Boolean {
