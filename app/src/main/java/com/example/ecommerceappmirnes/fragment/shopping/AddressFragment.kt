...
import com.example.ecommerceappmirnes.databinding.FragmentAddressBinding
import com.example.ecommerceappmirnes.util.Resource
import com.example.ecommerceappmirnes.viewmodel.AddressViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            buttonSave.setOnClickListener {
                ...
                val address= Address(addressTittle,fullName,street,phone,city,state)
